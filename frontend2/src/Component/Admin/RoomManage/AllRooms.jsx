...
const ManageRooms = () => {
  ...
  useEffect(() => {
    const sampleData = [
      ...
      },
      {
        ...
        Price: 70,
        Availability: 0,
        Features: "Garden view, Free breakfast",
      },
    ];
    setRooms(sampleData);
  }, []);
  ...
  const handleConfirmDelete = () => {
    setRooms((prevRooms) => prevRooms.filter((r) => r.RoomID !== selectedRoom.RoomID));
    ...
    style={{ width: "1000px" }}>
      ...
      <table className="table table-bordered table-striped rounded">
        ...
        <tr>
            ...
            <th onClick={() => handleSort("Features")}
              style={{ cursor: 'pointer' }}
            >
        ...
        <tbody>
          ...
          >
            {room.Availability === 1 ? "Available" : "Booked"}
          </span>
        </td>
                <td>{room.Features}</td>
                <td>
